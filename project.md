...
- **Current stage:** Stage 4 complete — ready to begin Stage 5.
- **Deployed:** nothing yet (Stage 4's Compose stack is proven locally against the real NAS backend, not yet ported to TrueNAS — that's Stage 5).
